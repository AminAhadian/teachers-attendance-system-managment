        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">سامانه جامع حضور و غیاب اساتید </h1>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="php-email-form">
                            <div class="qr-code-form">
                                <input type="text" autofocus id="attendanceCode" name="attendanceCode" maxlength="10"
                                    autofocus wire:model='attendanceCode' wire:change='save'
                                    placeholder="کد حضور و غیاب">
                            </div>
